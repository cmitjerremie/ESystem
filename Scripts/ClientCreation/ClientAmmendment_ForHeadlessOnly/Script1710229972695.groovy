...
WebUI.waitForElementVisible(findTestObject('Object Repository/ClientAmmendment/h4_Customers'), 20)
...
WebUI.setText(findTestObject('Object Repository/ClientAmmendment/input_FirstName_txtfname'), "")
WebUI.setText(findTestObject('Object Repository/ClientAmmendment/input_FirstName_txtfname'), fname + " Ammend")

WebUI.setText(findTestObject('Object Repository/ClientAmmendment/input_LastName_txtlname'), "")
...
WebUI.verifyElementPresent(findTestObject('Object Repository/ClientAmmendment/a_DOSRIRPT'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/ClientAmmendment/a_CRA'), 10)
...
WebUI.delay(1)
WebUI.waitForElementClickable(findTestObject('Object Repository/ClientAmmendment/button_Amend'), 20)
WebUI.click(findTestObject('Object Repository/ClientAmmendment/button_Amend'))
...
WebUI.waitForElementVisible(findTestObject('Object Repository/ClientAmmendment/h2_Are you sure you want to proceed'), 20)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/ClientAmmendment/div_The client amendment has been successfu_5db511'), 30)
