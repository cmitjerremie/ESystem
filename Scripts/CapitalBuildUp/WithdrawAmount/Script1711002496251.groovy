...
if (rowCount >= 1) {
	...
	WebUI.waitForElementVisible(findTestObject('Object Repository/CBU/div_Withdrawal of Cash has been successfully posted'), 10)
	...
	String msg_with = WebUI.getText(findTestObject('Object Repository/CBU/div_Withdrawal of Cash has been successfully posted'))
	
	if(msg_with == "Withdrawal of Cash has been successfully posted.")
	{
		println(msg_with)
		WebUI.delay(1)
	...
	{
		println("Error in cash withdrawal! msg: " + msg_with)
		KeywordUtil.markFailed("Error in cash withdrawal! msg: " + msg_with)
	}
}
else {
