...
WebUI.sendKeys(findTestObject('Object Repository/LoanManagementModule/LoanDraft/input_Search_form-control form-control-sm'), GlobalVariable.cid + Keys.chord(Keys.ENTER))
