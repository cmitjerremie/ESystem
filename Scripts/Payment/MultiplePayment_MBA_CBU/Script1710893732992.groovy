...
if (rowCount >= 1) {
	...
	WebUI.waitForElementVisible(findTestObject('Object Repository/PaymentModule/MultiplePayment/div_Multiple Payment was successfully Posted'), 10)
	String msg_mpay = WebUI.getText(findTestObject('Object Repository/PaymentModule/MultiplePayment/div_Multiple Payment was successfully Posted'))
	
	if(msg_mpay == "Multiple Payment was successfully Posted")
	{
		println("Multiple Payment Success! msg: " + msg_mpay)
	...
	{
		println("Error multiple payment msg: " + msg_mpay);
		KeywordUtil.markFailed("Error multiple payment msg: " + msg_mpay);
	}
}
else {
